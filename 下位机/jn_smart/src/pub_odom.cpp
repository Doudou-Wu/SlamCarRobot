...
int main(int argc, char** argv){
	...
	if(odom_msg.wh_l_buf[0] == 0x02 && odom_msg.wh_l_buf[1] == 0x0e)
        ...
        if(odom_msg.wh_r_buf[0] == 0x01 && odom_msg.wh_r_buf[1] == 0x0e){
        ...
        ROS_INFO("wheel_r == %d, wheel_l == %d \n",odom_msg.pos_r,odom_msg.pos_l);
